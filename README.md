# A project originally made for CodeStack Academy
...
X Add favorite Pokemon to localStorage
X Create sidebar to show favorited Pokemon
* Create new hamburger menu for navbar
* Create homepage for list of every pokemon up to Gen 5
X Create loading animations for fetching
* Create error assets in case of errors
X Create new favicon, preferably with Inkscape SVG
...
X Combine similar Pokedex entries
